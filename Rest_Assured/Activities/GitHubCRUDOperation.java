...
public class GitHubCRUDOperation {
    ...
    // Declare SSH Key
    String sshKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIN12Y80BEJTgCPdzdfDPipS0N4SN4aRWON17Rjuus0C6";
    // Fetch SSH Key ID
    int getSSHKeyID;
    ...
    public void setUp() {
        ...
        auth.setAccessToken("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");
