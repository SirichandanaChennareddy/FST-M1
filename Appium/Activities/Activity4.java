...
public class Activity4 {
    ...
    public void createContact() throws IOException {
        ...
        // Enter the details
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text='First name']")).sendKeys("Krishna");
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text='Last name']")).sendKeys("Chaitanya");
        driver.findElement(AppiumBy.xpath("//android.widget.EditText[@text='Phone']")).sendKeys("9848032919");
        // Click Save
        ...
        Assert.assertEquals(contactName, "Krishna Chaitanya");
    }
    @Test
